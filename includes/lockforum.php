...
else
{
	...
	if($modifier)
	{
		...
		<table class="texte_base_gras" width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
				<td align="center" class="cadre_clair" style="padding:30px"><p>Le statut de ce sujet a été modifié pour :
				';
				if($_GET['stat'] == 0) echo 'Ouvert';
				elseif($_GET['stat'] == -1) echo 'Verrouillé';
				elseif($_GET['stat'] == -2) echo 'Surverrouillé';
				echo'
				.</p>
				<p><a href="index.php?page=post&amp;ids='.intval($_GET['ids']).'">&gt;&gt; Retour au sujet. &lt;&lt;</a></p>
				</td>
            </tr>
			</table>
		';
