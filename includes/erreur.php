...
<table class="texte_base_gras" width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr align="center">
		<td height="29" class="titreforumend">Erreur</td>
	</tr>
	<tr>
		<td align="center" class="cadre1_bas" style="padding:30px"><p>Erreur, vous avez effectu&eacute; une op&eacute;ration non conforme</p> 
		<p><a href="index.php">&gt;&gt; Retour &agrave; la page principale &lt;&lt;</a></p></td>
	</tr>
</table>         