...
<table class="texte_base_gras" width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr align="center">
		<td height="29" class="titreforumend">Resynchronisation</td>
	</tr>
	<tr>
		<td align="center" class="cadre1_bas" style="padding:30px">
			<p><span class="titreforumend">Resynchronisation effectu&eacute;e avec succ&egrave;s</span></p
			><p><a href="index.php?page=post&amp;ids=<?php echo intval($_GET['ids']) ?>">&gt;&gt; Retour au sujet &lt;&lt;</a></p>
		</td>
	</tr>
</table>         