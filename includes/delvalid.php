...
<table class="texte_base_gras" width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr align="center">
		<td height="29" class="titreforum">Suppression de r&eacute;ponse</td>
	</tr>
	<tr>
		<td align="center" class="cadre_clair" style="padding:30px"><p>R&eacute;ponse supprim&eacute;e avec succ&egrave;es</p>
		<p><a href="index.php?page=post&amp;ids=<?php echo $_GET['id2'] ?>">&gt;&gt; Retour &agrave; la page du sujet &lt;&lt;</a></p></td>
	</tr>
</table>         