...
if($modifier)
{
	...
	<table class="texte_base_gras"  width="100%"  border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td align="center" class="cadre_clair" style="padding:30px"><p>Vous avez supprimé le sondage de ce sujet';
			echo'.</p><p><a href="index.php?page=post&ids='.$_GET['ids'].'">&gt;&gt; Retour au sujet. &lt;&lt;</a></p></td>
		</tr>
	</table>';
	}
	else
