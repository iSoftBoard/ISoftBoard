...
?>
		<table class="texte_base_gras" width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr align="center">
				<td height="29" class="titreforumend">D&eacute;connexion</td>
			</tr>
			<tr>
				<td align="center" class="cadre1_bas" style="padding:30px">
					<p>Etes-vous certain de vouloir vous d&eacute;connecter?</p> 
					<p><a href="index.php">Non, je veux retourner sur le forum</a> || <a href="logout.php">Oui, déconnectez moi</a></p>
				</td>
			</tr>
		</table>         