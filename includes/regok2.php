...
<table class="texte_base_gras" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="center" class="cadre_clair" style="padding:30px">Vous vous &ecirc;tes enregistr&eacute; avec succ&egrave;s,<br />Vous pouvez maintenant vous connecter.</td>
	</tr>
</table>         